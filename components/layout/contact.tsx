      ...
      <div className="container px-6 py-12 mx-auto">
        ...
        <div className="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2 lg:grid-cols-3">
          <div className="flex flex-col items-center justify-center text-center">
            <span className="p-3 text-foreground rounded-full bg-secondary">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6">
                <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
              </svg>
            </span>

            <h2 className="mt-4 text-lg font-medium text-background">Email</h2>
            <p className="mt-2 text-gray-500 dark:text-gray-400">Our friendly team is here to help.</p>
            <p className="mt-2 text-foreground">hello@merakiui.com</p>
          </div>
          ...
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <h2 className="mt-4 text-lg font-medium text-background">Office</h2>
            <p className="mt-2 text-gray-500 dark:text-gray-400">Come say hello at our office HQ.</p>
            <p className="mt-2 text-foreground">100 Smith Street Collingwood VIC 3066 AU</p>
          </div>
          ...
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <h2 className="mt-4 text-lg font-medium text-background">Phone</h2>
            <p className="mt-2 text-gray-500 dark:text-gray-400">Mon-Fri from 8am to 5pm.</p>
            <p className="mt-2 text-foreground">+1 (555) 000-0000</p>
          </div>
        </div>
      </div>
    </section>
